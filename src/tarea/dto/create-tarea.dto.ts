...
import { IsDateString, IsOptional, IsString, IsUUID, Length, IsIn } from 'class-validator';
...
export class CreateTareaDto {
    ...
    @ApiProperty({
        example: 'Escribir un ensayo de 500 palabras sobre las causas y consecuencias del calentamiento global...',
