...
export class ObservacionDocenteController {
  ...
  async create(
    ...
    return await this.observacionDocenteService.create(createObservacionDocenteDto, coordinadorId);
  }
  ...
  async cambiarEstado(
    ...
    return await this.observacionDocenteService.cambiarEstado(id, body.estado, coordinadorId, body.observaciones);
  }
  ...
  async findAll() {
    return await this.observacionDocenteService.findAll();
  }
  ...
  async findByTrabajador(@Param('idTrabajador') idTrabajador: string) {
    return await this.observacionDocenteService.findByTrabajador(idTrabajador);
  }
  ...
  async findByBimestre(@Param('idBimestre') idBimestre: string) {
    return await this.observacionDocenteService.findByBimestre(idBimestre);
  }
  ...
  async findByEstado(@Query('estado') estado: EstadoObservacionDocente) {
    return await this.observacionDocenteService.findByEstado(estado);
  }
  ...
  async findOne(@Param('id') id: string) {
    return await this.observacionDocenteService.findOne(id);
  }
  ...
  async update(
    ...
    const coordinadorId = req.user?.idTrabajador;
    return await this.observacionDocenteService.update(id, updateObservacionDocenteDto, coordinadorId);
  }
  ...
  async remove(@Param('id') id: string, @Request() req: any) {
    const coordinadorId = req.user?.idTrabajador;
    return await this.observacionDocenteService.remove(id, coordinadorId);
  }
}
